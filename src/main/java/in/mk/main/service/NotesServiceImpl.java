...
public class NotesServiceImpl implements NotesService {
	...
	public FilesDetails getFileDetails(Integer id) throws Exception {
		...
		FilesDetails filesDtls	=fileRepo.findById(id)
	...
	public NotesResponse getAllNotesByUser(Integer userId,Integer pageNo,Integer pageSize) {
		...
		Page<Notes> pagenotes= notesRepo.findByCreatedBy(userId,pageableObj);
		...
		NotesResponse  notesResponse =NotesResponse.builder()
				...
				.totalElement((int) pagenotes.getTotalElements())
